...
/*
$Id: complementarity.cpp 6326 2010-08-26 16:08:21Z nielsen $
*/
...
void Complementarity::set_parameters()
{

  string dummy;

  file.open("complementarity.cfg");
  ...
  printf("Version: $Id: complementarity.cpp 6326 2010-08-26 16:08:21Z nielsen $\n");
  printf("\n");
...
void Complementarity::writeDescription(FILE * reporter)
{
  /*** write out to out file **/
  version =string("$Id: complementarity.cpp 6326 2010-08-26 16:08:21Z nielsen $");
