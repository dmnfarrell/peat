 ...
 */
/*
$Id: nn_vdw.cpp 6326 2010-08-26 16:08:21Z nielsen $
*/
...
void NN_VDW::build_inputs(pose * A)
{
...
// 		    printf("Inputs: ");
// 		    for(int i=0; i< A->inputs[A->inputs.size()-1].size(); i++)
// 		      printf("'%f' ", A->inputs[A->inputs.size()-1][i]);
		
// 		    printf("  and indexes: ");
// 		    for(int i=0; i< A->indexes[A->indexes.size()-1].size(); i++)
...
void NN_VDW::write_network(string name)
{
...
void NN_VDW::read_network(string name)
{
  /*** save network to file ***/
 for(int i=0; i<no_types; i++)  
    for(int j=0; j<no_types; j++)
...
void NN_VDW::set_parameters()
{
  no_inputs =1;

  ifstream parameters;
  parameters.open("nn_vdw.cfg");

  if(! parameters.is_open())
    {
      cout << "Error:File 'nn_vdw.cfg' could not be found\n";
      exit(0);
    }
  ...
  printf("Version: $Id: nn_vdw.cpp 6326 2010-08-26 16:08:21Z nielsen $\n");
  printf("\n");
...
int NN_VDW::get_no_epochs(){return no_epochs;}
float NN_VDW::get_target_factor(){return target_factor;}
int NN_VDW::get_max_epochs_since_record(){return max_epochs_since_record;}
string NN_VDW::get_dataset(){return dataset;}

float NN_VDW::get_train_pct(){return train_pct;}
float NN_VDW::get_validate_pct(){return validate_pct;}
float NN_VDW::get_test_pct(){return test_pct;}

bool NN_VDW::get_include_co_factors()
{
...
void NN_VDW::writeDescription(FILE * reporter)
{
  /*** write out to out file **/
  version =string("$Id: nn_vdw.cpp 6326 2010-08-26 16:08:21Z nielsen $");
