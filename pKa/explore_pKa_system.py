...
class explore_system:
    ...
    def __init__(self):
        ...
        self.array_factor=100.0
        #
        # -----
        #
        self.intpka_range=range(200,1400,int(self.pka_resolution*self.array_factor))
        self.intene_range=range(0,1500,int(self.pka_resolution*self.array_factor))
